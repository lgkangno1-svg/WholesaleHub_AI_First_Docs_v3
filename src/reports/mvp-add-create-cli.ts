...
import { z } from "zod"
import { executeMvpAddCreate } from "./mvp-add-create.js"
...
async function main(): Promise<void> {
  ...
  const result = await executeMvpAddCreate({
  ...
  console.log(JSON.stringify({ report: result.report, verification: result.verification }, null, 2))
}
