...
final class WholesaleHub_Bulk_Order {
    ...
    public static function page(): void {
        ...
        echo '<section class="wh-bulk-order"><h2>엑셀 대량주문</h2><p>' . esc_html(self::LIMIT_MESSAGE) . '</p><p><a class="button" href="' . esc_url(admin_url('admin-post.php?action=wh_bulk_template')) . '">양식 다운로드</a></p>';
    ...
    public static function template(): void {
        ...
        self::xlsx('wholesalehub-bulk-order-template.xlsx', ['주문입력' => $rows, '상품목록' => self::catalog(), '작성안내' => [[self::LIMIT_MESSAGE],["한 행은 상품/옵션/수령지 1건입니다"],["가격과 배송비는 서버에서 다시 계산됩니다"],["같은 고객주문번호와 주소는 한 배송건으로 묶입니다"]]]);
    }
